...
test, it turned out to be a bad fitting. \todo{Dizer que deve ser uma
  distribuição entre exponencial e powerlaw ou então uma distribuição
  hibrida??}
...
\todo{Será que vale apena mencionar que o comportamento dos graficos
  com 50 000 utilizadores apesar de ser algo melhor (embora pouco)para
  probabilidades entre os 0.3 e os 0.8 não interessa, pois o erro
  individual é baixo nesses valores}

Global inaccuracy measures the ratio between the number of occurrences
